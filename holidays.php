...
//this function calculates easter and the corresponding dates are inserted into the array of holidays.
function calculateEaster ($year) {
  ...
  return array(explode('.',$easterFriday->format('j.n')), explode('.',$easterMonday->format('j.n')));
